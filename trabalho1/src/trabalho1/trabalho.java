...
public class trabalho {
	...
	public static void main(String[] args) {
        ...
        case 4:
            ...
            for(int procurador2 = 0 ; procurador2 < produtos; procurador2++) {   //Usei a mesma ideia do for do caso 2, para que junto com o if, ele procurasse se oque a pessoa pediu se assemelha ao que está armazenado
         	if(nomeProduto[procurador2].equals(produtoProcurado)) {
         		
         		System.out.println("Nome: "+nomeProduto[procurador2]);         //Coloquei as informações quando o nome do produto é encontrado
         		
                System.out.println("Valor de compra: " + valorCompra[procurador2]);
                
                System.out.println("Descrição: " + descricao[procurador2]);    //Uso o[procurador] para mudar o nome citado pela pessoa apenas
        ...
        case 5:
        	...
        	produtoEscolhido = ler.nextInt();
        	                                    ...
        	                                    //Fiz o if pra saber a quantidade que será a vendida
